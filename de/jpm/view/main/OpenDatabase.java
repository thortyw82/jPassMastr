 ...
 * @author thorty
 */
public class OpenDatabase extends JDialog implements ActionListener  {
     ...
     * @param doing
     */
    public OpenDatabase(String doing){
        job = doing;
        initGetDatabasePass();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b_ok){
            if ( t_pass.getPassword().length != 0 && job.equals("save") ){
                try {
            ...
            if ( t_pass.getPassword().length != 0 && job.equals("open") ){
                try {
                    MainController.getEntryController().setPass(t_pass.getPassword());                    
                 ...
                 nachricht.setText(MainController.bundle.getString("OpenDatabase.message"));
